...
They are the most populous species in the world, and are reliable, resilient and versatile. Their natural hardiness grants humans 1 boost on Mental Defense (MD) rolls. They usually live to 85 years of age, but some have surpassed that, living for more than 120 years of age.
...
This spell is usually cast on a door, gate, or other type of portal closure system. It prevents the portal from being open for the duration of the spell.
...
Traditionally, room descriptions are detailed in a narrative form. Some game modules even go as far as having a highlighted section that is to be read to the players.
...
One of the things that players will find and seek while they are adventuring is magical items. These can be magic-imbued weapons, staves, rods, scrolls, and potions, all of them with a particular magical effect.
...
## Appendix B - Class/species base action rolls

To ease basic character creation, here’s a matrix showing the different combat rolls based on class and race. This table also allows direct comparison between the different species and class combinations, allowing you to choose the one closer to what you want in your character.
